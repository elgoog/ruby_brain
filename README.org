...
** MNIST
   Following code is included in [[https://github.com/%5Bmy-github-username%5D/ruby_brain/examples/mnist.rb][examples/mnist.rb]]
   ...
   The weights file is [[https://github.com/elgoog/weights_ruby_brain/weights_782_50_10_1.yml][here]].
